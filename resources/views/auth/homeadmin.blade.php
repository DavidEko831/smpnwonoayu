    ...
    <nav class="bg-[#FEC868] h-auto relative" x-data="{ isOpen: false }">
            ...
            <div class="flex items-center h-16 md:h-40 relative">
                ...
                <div x-data="{ isOpen: false }" class="hidden md:block absolute right-56">
                    <div>
                        <button @click="isOpen = !isOpen" type="button"
                            ...
                            <svg width="45" height="45" viewBox="0 0 45 45" fill="none"
                                xmlns="http://www.w3.org/2000/svg" class="bg-[#FEC868]">
                    ...
                    <div x-show="isOpen" @click.away="isOpen = false"
                        class="absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-[#ABC270] ring-1 ring-black ring-opacity-5"
                        ...
                        <a href="/homeadmin/postingan"
                            ...
                            role="menuitem" tabindex="-1" id="user-menu-item-0">Postingan</a>
                        <a href="/homeadmin/tentangKamiadmin"
                            class="block px-4 py-2 text-base text-white hover:text-gray-700 hover:bg-gray-100"
                            role="menuitem" tabindex="-1" id="user-menu-item-1">Bantuan</a>
        ...
        <div x-show="isOpen" class="md:hidden" id="mobile-menu">
            ...
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                <a href="{{ route('logout') }}"
                    class="block px-3 py-2 text-base font-medium text-white rounded-md hover:bg-black"><img
                        src="" alt="" />KELUAR</a>
                <a href="/homeadmin"
                    class="block px-3 py-2 text-base font-medium text-white rounded-md hover:bg-black"><img
                        src="" alt="" />BERANDA</a>
            ...
            <div class="hidden md:grid grid-cols-2 place-items-center absolute inset-0 z-20">
                ...
                <div class="text-center">
                    <h3 class="text-white font-bold text-[50px] mb-2">
                        IDE<br />WIRASUSAHA SMPN 1 WONOAYU
                    </h3>
                    <hr class="border-b-8 border-[#FDC300] mb-2 w-11/12" />
                    <h4 class="text-white text-[25px] font-bold break-words w-11/12">
                        Ide wirausaha smpn 1 wonoayu sudah berjalan cukup lama dan sudah berjalan samapi detik ini untuk bisa menambah nilai jual di smpn 1 wonoayu
                    </h4>
                </div>
            </div>
        </section>
        ...
        <section class="bg-[url('/gambar/1.jpg')] bg-cover bg-center h-[663px] relative mt-4">
            ...
            <div
                ...
                <h4 class="text-white text-center text-[12px] font-bold mt-12 break-words">
                    SMPN 1 WONOAYU  adalah sebuah sekolah di wilayah <br />
                    Kecamatan Wonoayu, Kabupaten Sidoarjo, <br />
                    Provinsi Jawa Timur. <br />
                    Sekolah ini berdiri di sebelah SDN WONOAYU <br />
                    RW Dan 10 RT. Pusat pemerintahan <br />
                    sekolah ini berada di sekitar Balai Desa Semambung yang <br />
            ...
            <div class="hidden md:grid grid-cols-2 place-items-center absolute inset-0 z-20">
                <div class="text-center">
                    ...
                    <p class="text-white text-[25px] font-bold break-words pl-2">
                        SMPN 1 WONOAYU  adalah sebuah sekolah di wilayah
        ...
        <section
            ...
            <div class="z-20 text-center flex flex-col gap-y-10">
                ...
                <p
                    ...
                    Yuk buruan masukan produkmu ! <br />
